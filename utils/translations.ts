export const translations = {
  en: {
    ...
    modelSettings: {
      ...
      outputDesc: "The folder for saving model labels can be different from the manual labels folder. If this option is not defined, it overwrites the manual folder files.",
